...
Built up Structures: Block Type A G+9 (5 blocks, 26,755 sqm), Block Type B G+9 (6 blocks, 40,692 sqm), Commercial Stalls (249 sqm), Kindergarten (552 sqm), Guard House (2, 30 sqm), Garbage Receptacle (2, 206 sqm), Power House (24 sqm). External works: Roads, Sewer & Parking works, Boundary wall & underground water tank. Total units: 1035 units comprising social, affordable and market rate houses.",
                ...
                StartDate = DateTimeHelper.Utc(2025, 6, 26),
                EndDate = DateTimeHelper.Utc(2026, 12, 26),
                Status = ProjectStatus.Active,
                Latitude = 0.984000,
                Longitude = 34.984396,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 23,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 27),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 6, 19),
                EndDate = DateTimeHelper.Utc(2026, 12, 19),
                Status = ProjectStatus.Active,
                Latitude = 0.526938, 
                Longitude = 35.262038,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 9.76m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 25),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 7, 16),
                EndDate = DateTimeHelper.Utc(2026, 4, 16),
                Status = ProjectStatus.Active,
                Latitude = 0.31536,
                Longitude = 35.15473,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 62.19m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 19),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 5),
                EndDate = DateTimeHelper.Utc(2027, 5, 5),
                Status = ProjectStatus.Active,
                Latitude = 0.0601,
                Longitude = 35.1035,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 11.70m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 23),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 6, 23),
                EndDate = DateTimeHelper.Utc(2026, 12, 23),
                Status = ProjectStatus.Active,
                Latitude = 0.204281,
                Longitude = 35.109664,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 16.20m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 28),
...
65 Shops, Garbage Receptacles (2), Guard House (3), Power House, Basketball Pitch, Underground water tank, Civil works (Roads & Sewer), Swimming Pool, Club House, Kindergarten/ECD, School, Community Centre",
                ...
                StartDate = DateTimeHelper.Utc(2025, 4, 4),
                EndDate = DateTimeHelper.Utc(2027, 3, 25),
                Status = ProjectStatus.Active,
                Latitude = 0.52823,
                Longitude = 35.26206,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 10, 17),
                EndDate = DateTimeHelper.Utc(2027, 5, 17),
                Status = ProjectStatus.Active,
                Latitude = 0.3677222,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 12, 2),
                EndDate = DateTimeHelper.Utc(2026, 8, 12),
                Status = ProjectStatus.Active,
                Latitude = 0.40617,
                Longitude = 35.3045,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 10, 13),
                EndDate = DateTimeHelper.Utc(2027, 4, 17),
                Status = ProjectStatus.Active,
                Latitude = 0.6703,
                Longitude = 35.5075,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 7, 16),
                EndDate = DateTimeHelper.Utc(2026, 7, 16),
                Status = ProjectStatus.Active,
                Latitude = 0.572345,
                Longitude = 35.310227,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 77.20m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 24),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2023, 10, 28),
                EndDate = DateTimeHelper.Utc(2026, 3, 31),
                Status = ProjectStatus.Active,
                Latitude = 0.31536,
                Longitude = 35.15473,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 98,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 18),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 20),
                EndDate = DateTimeHelper.Utc(2027, 6, 20),
                Status = ProjectStatus.Active,
                Latitude = 1.2138344,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 7, 15),
                EndDate = DateTimeHelper.Utc(2026, 4, 15),
                Status = ProjectStatus.Active,
                Latitude = -0.3598043,
                Longitude = 35.28986,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 10, 10),
                EndDate = DateTimeHelper.Utc(2027, 4, 10),
                Status = ProjectStatus.Active,
                Latitude = 0.687378,
                Longitude = 35.109831,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 3, 29),
                EndDate = DateTimeHelper.Utc(2027, 3, 29),
                Status = ProjectStatus.Active,
                Latitude = -0.1431027,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 12, 5),
                EndDate = DateTimeHelper.Utc(2026, 12, 5),
                Status = ProjectStatus.Active,
                Latitude = 0.494873,
                Longitude = 35.73708,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 5, 12),
                EndDate = DateTimeHelper.Utc(2026, 11, 12),
                Status = ProjectStatus.Active,
                Latitude = 0.47306,
                Longitude = 35.979379,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 1, 20),
                EndDate = DateTimeHelper.Utc(2026, 7, 20),
                Status = ProjectStatus.Active,
                Latitude = -1.00028,
                Longitude = 34.87665,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 8, 14),
                EndDate = DateTimeHelper.Utc(2027, 2, 14),
                Status = ProjectStatus.Active,
                Latitude = -0.70286,
                Longitude = 35.334631,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 7, 9),
                EndDate = DateTimeHelper.Utc(2027, 1, 9),
                Status = ProjectStatus.Active,
                Latitude = -0.784635,
                Longitude = 36.432858,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 23),
                EndDate = DateTimeHelper.Utc(2027, 1, 23),
                Status = ProjectStatus.Active,
                Latitude = -0.010056,
                Longitude = 35.964128,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 1.50m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 26),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 7, 15),
                EndDate = DateTimeHelper.Utc(2026, 1, 7),
                Status = ProjectStatus.Active,
                Latitude = 1.093091,
                Longitude = 36.689542,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 7, 14),
                EndDate = DateTimeHelper.Utc(2027, 1, 14),
                Status = ProjectStatus.Active,
                Latitude = 0.663735,
                Longitude = 37.667609,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 1),
                EndDate = DateTimeHelper.Utc(2026, 9, 30),
                Status = ProjectStatus.Active,
                Latitude = 1.090094,
                Longitude = 34.805747,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 5,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 1, 1),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 6, 24),
                EndDate = DateTimeHelper.Utc(2024, 12, 24),
                Status = ProjectStatus.Active,
                Latitude = 1.0664,
                Longitude = 35.1328,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 2, 6),
                EndDate = DateTimeHelper.Utc(2027, 2, 6),
                Status = ProjectStatus.Active,
                Latitude = -1.615425,
                Longitude = 35.661312,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 4, 23),
                EndDate = DateTimeHelper.Utc(2024, 10, 23),
                Status = ProjectStatus.Active,
                Latitude = -1.003578,
                Longitude = 35.66316,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 2, 19),
                EndDate = DateTimeHelper.Utc(2025, 11, 18),
                Status = ProjectStatus.Active,
                Latitude = 0.164444,
                Longitude = 35.524722,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 99.80m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 1, 31),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 10, 2),
                EndDate = DateTimeHelper.Utc(2026, 10, 2),
                Status = ProjectStatus.Active,
                Latitude = -0.695147,
                Longitude = 35.10801,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 3,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 5),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 12, 23),
                EndDate = DateTimeHelper.Utc(2025, 6, 23),
                Status = ProjectStatus.Active,
                Latitude = 1.038503,
                Longitude = 35.322287,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 10,
                LastProgressUpdate = DateTimeHelper.Utc(2025, 10, 10),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 2, 7),
                EndDate = DateTimeHelper.Utc(2027, 2, 7),
                Status = ProjectStatus.Active,
                Latitude = -1.008222,
                Longitude = 34.880222,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 4, 25),
                EndDate = DateTimeHelper.Utc(2024, 10, 28),
                Status = ProjectStatus.Active,
                Latitude = 0.296095,
                Longitude = 35.325614,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 7, 23),
                EndDate = DateTimeHelper.Utc(2025, 1, 22),
                Status = ProjectStatus.Active,
                Latitude = -0.176656,
                Longitude = 36.245203,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 5, 10),
                EndDate = DateTimeHelper.Utc(2025, 11, 10),
                Status = ProjectStatus.Active,
                Latitude = 0.096131,
                Longitude = 35.5037,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 19),
                EndDate = DateTimeHelper.Utc(2026, 8, 19),
                Status = ProjectStatus.Active,
                Latitude = 0.961554,
                Longitude = 34.932297,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 5,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 8),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 6, 5),
                EndDate = DateTimeHelper.Utc(2025, 11, 20),
                Status = ProjectStatus.Active,
                Latitude = -0.57342,
                Longitude = 35.61401,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 7, 23),
                EndDate = DateTimeHelper.Utc(2025, 1, 23),
                Status = ProjectStatus.Active,
                Latitude = 0.005982,
                Longitude = 35.310048,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 5, 13),
                EndDate = DateTimeHelper.Utc(2024, 11, 13),
                Status = ProjectStatus.Active,
                Latitude = 1.255286,
                Longitude = 35.09195,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 20),
                EndDate = DateTimeHelper.Utc(2026, 11, 20),
                Status = ProjectStatus.Active,
                Latitude = 0.893047,
                Longitude = 34.924821,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 1),
                EndDate = DateTimeHelper.Utc(2026, 11, 1),
                Status = ProjectStatus.Active,
                Latitude = 1.218322,
                Longitude = 34.735619,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 5, 5),
                EndDate = DateTimeHelper.Utc(2026, 1, 12),
                Status = ProjectStatus.Active,
                Latitude = 0.448643,
                Longitude = 35.235109,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 5, 14),
                EndDate = DateTimeHelper.Utc(2024, 11, 13),
                Status = ProjectStatus.Active,
                Latitude = -0.229278,
                Longitude = 36.134333,
            ...
            new Project
            {
                ...
                ContractSum = 151147005m,
                StartDate = DateTimeHelper.Utc(2024, 6, 19),
                EndDate = DateTimeHelper.Utc(2024, 12, 17),
                Status = ProjectStatus.Active,
                Latitude = 0.00938,
                Longitude = 36.2125,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 7, 23),
                EndDate = DateTimeHelper.Utc(2026, 4, 23),
                Status = ProjectStatus.Active,
                Latitude = -0.511928,
                Longitude = 35.975946,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 56.50m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 2, 20),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 9),
                EndDate = DateTimeHelper.Utc(2026, 11, 8),
                Status = ProjectStatus.Active,
                Latitude = 1.785569,
                Longitude = 36.789939,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 6,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 3, 1),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 3, 27),
                EndDate = DateTimeHelper.Utc(2024, 9, 26),
                Status = ProjectStatus.Active,
                Latitude = 0.322059,
                Longitude = 35.17014,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 4, 30),
                EndDate = DateTimeHelper.Utc(2024, 10, 30),
                Status = ProjectStatus.Active,
                Latitude = -0.966188,
                Longitude = 35.190675,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 24),
                EndDate = DateTimeHelper.Utc(2026, 3, 23),
                Status = ProjectStatus.Active,
                Latitude = 0.0667,
                Longitude = 35.05,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                ContractSum = 113007173m,
                StartDate = DateTimeHelper.Utc(2024, 4, 9),
                EndDate = DateTimeHelper.Utc(2024, 10, 24),
                Status = ProjectStatus.Active,
                Latitude = 0.82,
                Longitude = 35.38,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                ContractSum = 147275817m,
                StartDate = DateTimeHelper.Utc(2024, 4, 23),
                EndDate = DateTimeHelper.Utc(2024, 10, 25),
                Status = ProjectStatus.Active,
                Latitude = 1.486858,
                Longitude = 35.472625,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 47.20m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 1, 21),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 12, 1),
                EndDate = DateTimeHelper.Utc(2026, 12, 1),
                Status = ProjectStatus.Active,
                Latitude = 3.707505,
                Longitude = 34.882983,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                ContractSum = 153438857.40m,
                StartDate = DateTimeHelper.Utc(2024, 11, 27),
                EndDate = DateTimeHelper.Utc(2026, 5, 27),
                Status = ProjectStatus.Active,
                Latitude = -0.565011,
                Longitude = 36.11705,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 7, 29),
                EndDate = DateTimeHelper.Utc(2026, 7, 29),
                Status = ProjectStatus.Active,
                Latitude = -1.08519,
                Longitude = 35.87806,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                LastProgressUpdate = DateTimeHelper.Utc(2026, 3, 2),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 5, 23),
                EndDate = DateTimeHelper.Utc(2026, 5, 23),
                Status = ProjectStatus.Active,
                Latitude = 0.670125,
                Longitude = 35.5098,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 12, 9),
                EndDate = DateTimeHelper.Utc(2026, 12, 9),
                Status = ProjectStatus.Active,
                Latitude = -1.090546,
                Longitude = 35.85415,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 10, 6),
                EndDate = DateTimeHelper.Utc(2026, 10, 6),
                Status = ProjectStatus.Active,
                Latitude = 3.069444,
                Longitude = 35.614167,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 12, 3),
                EndDate = DateTimeHelper.Utc(2027, 6, 3),
                Status = ProjectStatus.Active,
                Latitude = -0.792072,
                Longitude = 35.332051,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 29),
                EndDate = DateTimeHelper.Utc(2027, 1, 28),
                Status = ProjectStatus.Active,
                Latitude = -1.108336,
                Longitude = 36.005554,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 30),
                EndDate = DateTimeHelper.Utc(2026, 12, 1),
                Status = ProjectStatus.Active,
                Latitude = 0.03925,
                Longitude = 35.72821,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 12, 16),
                EndDate = DateTimeHelper.Utc(2026, 12, 16),
                Status = ProjectStatus.Active,
                Latitude = -0.246973,
                Longitude = 36.149182,
                RadiusInMeters = 500,
                CurrentPhysicalProgress = 16.29m,
                LastProgressUpdate = DateTimeHelper.Utc(2026, 1, 23),
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 2, 16),
                EndDate = DateTimeHelper.Utc(2027, 2, 16),
                Status = ProjectStatus.Active,
                Latitude = -0.16,
                Longitude = 35.69,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 16),
                EndDate = DateTimeHelper.Utc(2027, 1, 16),
                Status = ProjectStatus.Active,
                Latitude = 1.24,
                Longitude = 35.12,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 1),
                EndDate = DateTimeHelper.Utc(2027, 1, 13),
                Status = ProjectStatus.Active,
                Latitude = 1.49597,
                Longitude = 35.47271,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 22),
                EndDate = DateTimeHelper.Utc(2027, 1, 23),
                Status = ProjectStatus.Active,
                Latitude = 0.548161,
                Longitude = 35.286149,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 2, 26),
                EndDate = DateTimeHelper.Utc(2027, 2, 26),
                Status = ProjectStatus.Active,
                Latitude = 1.389017,
                Longitude = 35.190992,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 11, 7),
                EndDate = DateTimeHelper.Utc(2026, 11, 7),
                Status = ProjectStatus.Active,
                Latitude = 4.279788,
                Longitude = 35.892157,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 1, 29),
                EndDate = DateTimeHelper.Utc(2027, 1, 29),
                Status = ProjectStatus.Active,
                Latitude = 3.716667,
                Longitude = 35.833333,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2024, 3, 7),
                EndDate = DateTimeHelper.Utc(2026, 3, 7),
                Status = ProjectStatus.Active,
                Latitude = 0.515961,
                Longitude = 35.272758,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 8, 16),
                EndDate = DateTimeHelper.Utc(2027, 2, 16),
                Status = ProjectStatus.Active,
                Latitude = 0.2039,
                Longitude = 35.1063,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 5, 7),
                EndDate = DateTimeHelper.Utc(2026, 5, 7),
                Status = ProjectStatus.Active,
                Latitude = 0.106257,
                Longitude = 35.183235,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                ContractSum = 110850481m,
                StartDate = DateTimeHelper.Utc(2024, 7, 17),
                EndDate = DateTimeHelper.Utc(2025, 1, 17),
                Status = ProjectStatus.Active,
                Latitude = -1.153364,
                Longitude = 35.761588,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2026, 2, 3),
                EndDate = DateTimeHelper.Utc(2026, 11, 3),
                Status = ProjectStatus.Active,
                Latitude = -0.784635,
                Longitude = 36.432858,
                RadiusInMeters = 500,
            ...
            new Project
            {
                ...
                StartDate = DateTimeHelper.Utc(2025, 10, 28),
                EndDate = DateTimeHelper.Utc(2026, 10, 28),
                Status = ProjectStatus.Active,
                Latitude = -0.470784,
                Longitude = 36.334415,
                RadiusInMeters = 500,
            ...
            // Add these to ProjectSeedData.Projects list
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2025, 10, 2),
                    EndDate = DateTimeHelper.Utc(2026, 10, 27),
                    Status = ProjectStatus.Active,
                    Latitude = -0.154841,
                    Longitude = 36.144773,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2025, 8, 26),
                    EndDate = DateTimeHelper.Utc(2026, 8, 26),
                    Status = ProjectStatus.Active,
                    Latitude = 0.07651,
                    Longitude = 35.07226,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2024, 6, 5),
                    EndDate = DateTimeHelper.Utc(2025, 1, 13),
                    Status = ProjectStatus.Active,
                    Latitude = 0.00364,
                    Longitude = 36.22974,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    LastProgressUpdate = DateTimeHelper.Utc(2026, 1, 27),
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2024, 4, 26),
                    EndDate = DateTimeHelper.Utc(2024, 10, 25),
                    Status = ProjectStatus.Active,
                    Latitude = -0.63142,
                    Longitude = 35.19748,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2025, 7, 25),
                    EndDate = DateTimeHelper.Utc(2027, 1, 22),
                    Status = ProjectStatus.Active,
                    Latitude = -1.015488,
                    Longitude = 36.469896,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2024, 8, 26),
                    EndDate = DateTimeHelper.Utc(2025, 2, 26),
                    Status = ProjectStatus.Active,
                    Latitude = -0.371877,
                    Longitude = 35.684658,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    ContractSum = 180555172.00m,
                    StartDate = DateTimeHelper.Utc(2024, 5, 22),
                    EndDate = DateTimeHelper.Utc(2024, 11, 22),
                    Status = ProjectStatus.Active,
                    Latitude = 0.427105,
                    Longitude = 35.69197,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2025, 11, 17),
                    EndDate = DateTimeHelper.Utc(2026, 11, 16),
                    Status = ProjectStatus.Active,
                    Latitude = 0.87394,
                    Longitude = 35.11992,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2024, 6, 12),
                    EndDate = DateTimeHelper.Utc(2024, 12, 12),
                    Status = ProjectStatus.Active,
                    Latitude = -0.173871,
                    Longitude = 35.862151,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2025, 7, 4),
                    EndDate = DateTimeHelper.Utc(2026, 4, 28),
                    Status = ProjectStatus.Active,
                    Latitude = 0.166667,
                    Longitude = 35.15,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2024, 4, 18),
                    EndDate = DateTimeHelper.Utc(2024, 10, 18),
                    Status = ProjectStatus.Active,
                    Latitude = 1.43746,
                    Longitude = 35.35484,
                    RadiusInMeters = 500,
                ...
                new Project
                {
                    ...
                    StartDate = DateTimeHelper.Utc(2025, 3, 7),
                    EndDate = DateTimeHelper.Utc(2026, 3, 6),
                    Status = ProjectStatus.Active,
                    Latitude = 0.211886,
                    Longitude = 36.161838,
                    RadiusInMeters = 500,
